...
python scripts/studies/embedding_unimol.py || echo "Uni-Mol extraction failed (non-fatal)"

echo ""
echo "=== Phase C: SchNet QM9-pretrained embedding extraction ==="
python scripts/studies/embedding_schnet.py || echo "SchNet extraction failed (non-fatal)"
