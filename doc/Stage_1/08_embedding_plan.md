...
已有脚本：`scripts/studies/embedding_multilayer.py`（提取）、`scripts/studies/gp_multilayer.py`（GP 评估）。
...
1. 在 GPU 节点上将 `scripts/studies/embedding_multilayer.py` 跑满 942 个 pocket
