...
### Scripts & Jobs
- `scripts/26b_extract_unimol.py` — Uni-Mol extraction (Job 5123719, a100_chemistry)
- `scripts/26d_compare_embeddings.py` — 17 configs comparison (6 figures)
- `scripts/28c_subsample_ablation.py` — Subsample ablation (Job 5127962, cpu_short)
- `scripts/26c_extract_schnet.py` — SchNet extraction (Job 5130267, pending)
...
- `doc/pretrained_embedding_plan.md` — 完整结果 & 结论
...
| Item | Details |
|------|---------|
| **Script** | `scripts/25_regularization_study.py` |
...
| Item | Details |
|------|---------|
| **Script** | `scripts/24_tier3_training_curves_analysis.py` |
