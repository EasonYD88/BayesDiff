...
**脚本**: `scripts/scaling/s07_extract_50mol_embeddings.py` (replaces old merge-only script)
...
**脚本**: `scripts/studies/gp_50mol_study.py` (Part 1)
...
**脚本**: `scripts/studies/gp_50mol_study.py` (Part 2)
...
**脚本**: `scripts/studies/gp_50mol_study.py` (Part 3)
...
**脚本**: `scripts/studies/gp_50mol_study.py` (Part 4)
...
**A5 补充脚本**: `scripts/studies/subsample_ablation.py`
...
- `doc/09_progress_log.md` — 添加 50mol 实验结果
- `doc/06_gp_optimization.md` — 更新最优配置
- `doc/07_50mol_study_plan.md` — 标记完成状态
